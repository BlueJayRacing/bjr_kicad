...
//2372198/1215358/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS7150QDR" (originalName "TPS7150QDR")
	...
	(compDef "TPS7150QDR" (originalName "TPS7150QDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "__EN") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "IN_1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "IN_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "PG") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "SENSE†") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "OUT_2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS7150QDR"))
		...
		(attr "Mouser Part Number" "595-TPS7150QDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS7150QDR?qs=Gse6rAGbi79xIQtuYfAffQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS7150QDR")
		(attr "Description" "LDO Voltage Regulators Lowest Dropout PMOS")
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/TPS71")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TPS7150QDR.stp")
